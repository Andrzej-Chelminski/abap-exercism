CLASS ltcl_exercism_reverse_string DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.

  PRIVATE SECTION.
    DATA cut TYPE REF TO zcl_exercism_reverse_string.
...
CLASS ltcl_exercism_reverse_string IMPLEMENTATION.

  METHOD setup.
    cut = NEW zcl_exercism_reverse_string( ).
  ENDMETHOD.
