CLASS ltcl_exercism_scrabble_score DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.

  PRIVATE SECTION.
    DATA cut TYPE REF TO zcl_exercism_scrabble_score.
    METHODS setup.
...
CLASS ltcl_exercism_scrabble_score IMPLEMENTATION.

  METHOD setup.
    cut = NEW zcl_exercism_scrabble_score( ).
  ENDMETHOD.
